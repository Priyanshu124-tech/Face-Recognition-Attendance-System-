...
class Student:
  ...
  ## fetch data 
     def fetch_data(self): 
         conn=mysql.connector.connect(host="localhost", username="root", password="987456321",database="face_recognizer")
     ...
     def __init__(self,root):
        ...
        self.var_dep.set("cse")
        self.var_course= StringVar()
        self.var_course.set('btech')
        self.var_year= StringVar()
        self.var_year.set('3rd')
        self.var_semester= StringVar()
        self.var_semester.set('5th')
        self.var_std_id= StringVar()
        self.var_std_id.set(1234)
        self.var_std_name= StringVar()
        self.var_std_name.set('demo')
        self.var_div= StringVar()
        self.var_div.set('A')
        self.var_roll= StringVar()
        self.var_roll.set('420')
        self.var_gender= StringVar()
        self.var_gender.set('T')
        self.var_dob= StringVar()
        self.var_dob.set('not born yet')
        self.var_email= StringVar()
        self.var_email.set('example@gmail.com')
        self.var_phone= StringVar()
        self.var_phone.set('12345566789')
        self.var_address= StringVar()
        self.var_address.set('sstc')
        self.var_teacher= StringVar()
        self.var_teacher.set('hello world')
        ...
        #second image
        img1=Image.open(r"college_images/Student2 (2).jpg")
        ...
        img3=Image.open(r"college_images/bg img.jpg")
        ...
        #address
        address_label=Label(class_Student_frame,text="Adress:",font=("times new roman",13,"bold"),bg="white")
        ...
        img_right=Image.open(r"college_images/Right label.jpg")
        ...
        searchshowALL_btn=Button(Search_frame,text="Search",width=11,font=("times new roman",12,"bold"),bg="blue",fg="white")
        searchshowALL_btn.grid(row=0,column=3,padx=4)
