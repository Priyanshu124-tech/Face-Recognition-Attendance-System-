...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl=Label(bg_img,text="FACE RECOGNITION ATTTENDANCE SYSTEM SOFTWARE", font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        b1_1.place(x=500,y=300,width=220,height=40)
         ...
         #Attendace button
        img6=Image.open(r"college_images/img6.jpg")
        ...
        #Help button
        img7=Image.open(r"college_images/img7.jpg")
        ...
        b1_1.place(x=1100,y=300,width=220,height=40)
         ...
         #Train button
        img8=Image.open(r"college_images/img8.jpg")
        ...
        #Photos button
        img9=Image.open(r"college_images/img9.jpg")
        ...
        #Developer button
        img10=Image.open(r"college_images/img10.jpg")
        ...
        #Exit button
        img11=Image.open(r"college_images/img11.jpg")
...
if __name__ =="__main__":
    root=Tk()
    root.geometry('1000x800+10+10') # geometry
